  ...
  implements IDataSerializable
{
  ...
  public static Quaternion getRotationQuaternion(FzOrientation orient) {
    ...
    return getRotationQuaternionRadians(Math.toRadians(orient.getRotation() * 90), facing);
  }
  ...
  public static Quaternion fromOrientation(FzOrientation orient)
  {
    ...
    Quaternion q1;
    switch (2.$SwitchMap$net$minecraftforge$common$ForgeDirection[facing.ordinal()]) {
    case 1:
    ...
    case 5:
      ...
      rotation += Math.abs(top.offsetZ) * 2;
      break;
    case 6:
      q1 = getRotationQuaternionRadians(-1.0D * quart, ForgeDirection.NORTH);
      rotation += Math.abs(top.offsetY) * 2;
      break;
    default:
      return quat_cache[ord] =  = new Quaternion();
    }
    Quaternion q2 = getRotationQuaternionRadians(rotation * quart, facing);
    q2.incrMultiply(q1);
